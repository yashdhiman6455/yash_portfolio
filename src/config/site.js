...
export const about = {
  ...
  highlights: [
    { label: 'Experience', value: '3+ Years', icon: 'experience' },
    { label: 'Core Stack', value: 'Laravel / PHP', icon: 'stack' },
    { label: 'APIs', value: 'REST APIs', icon: 'api' },
    { label: 'Development', value: 'Full-Stack', icon: 'dev' },
  ],
  journey: [
    {
      year: '2023',
      title: 'Professional Web Development',
      text: 'Started professional development with PHP, HTML, CSS, JavaScript and MySQL, building responsive, production-ready web applications with modern practices.',
      tech: ['PHP', 'HTML', 'CSS', 'JavaScript', 'MySQL'],
    },
    {
      year: '2024',
      title: 'Laravel & API Development',
      text: 'Expanded into Laravel, REST APIs, authentication, database architecture and integrations — shipping real-world applications and advanced CRUD systems on scalable backends.',
      tech: ['Laravel', 'REST APIs', 'Authentication', 'MySQL'],
    },
    {
      year: '2025',
      title: 'Full-Stack Development',
      text: 'Strengthened expertise across Laravel, JavaScript, Vue.js, MySQL and API integrations, delivering production applications with end-to-end features and Git-based workflows.',
      tech: ['Laravel', 'JavaScript', 'Vue.js', 'MySQL', 'Git'],
    },
    {
      year: '2026',
      title: 'AI & Modern Full-Stack Development',
      text: 'Building advanced applications with AI integration across PHP, Laravel, Vue.js and REST APIs — expanding toward AI-powered SaaS and modern full-stack development.',
      tech: ['PHP', 'Laravel', 'Vue.js', 'AI Integration', 'REST APIs'],
    },
  ],
}
...
export const skillCategories = [
  {
    ...
    title: 'Backend',
    icon: 'server',
    description: 'Where I spend most of my time — business logic and data.',
    skills: ['PHP', 'Laravel', 'Eloquent'],
  },
  {
    id: 'frontend',
    title: 'Frontend',
  ...
  },
  {
    ...
    title: 'Database',
    icon: 'database',
    description: 'Relational modelling and schema design for production data.',
  ...
  },
  {
    ...
    icon: 'route',
    description: 'Designing, securing and consuming REST APIs end to end.',
    skills: ['REST APIs', 'Authentication', 'Postman'],
  },
  {
    id: 'tools',
    ...
    skills: ['Git', 'GitHub', 'Docker', 'Vite', 'Composer'],
  },
  {
    id: 'learning',
...
export const projects = [
  ...
  },
  {
    id: 'staynest',
    name: 'StayNest',
    tagline: 'Full-stack property rental and booking platform built with Laravel 11, Vue.js 3 and MySQL.',
    status: 'Latest Project',
    year: '2026',
    featured: true,
    preview: 'rental',
    ...
    problem:
      'Travelers and property owners need a streamlined platform for discovering, listing and managing rental properties. Existing solutions are either too complex or lack the flexibility of a modern, decoupled architecture.',
    solution:
      'A Laravel 11 REST API backend with Vue.js 3 SPA frontend, using Laravel Sanctum for token-based authentication, Pinia for state management, Axios for API communication and Vue Router for client-side navigation. Properties, bookings and user data are managed through a MySQL database.',
    features: [
    ...
    flow: [
      { label: 'Vue.js SPA', detail: 'User interacts with the Vue.js frontend' },
      { label: 'Axios', detail: 'API requests sent to Laravel backend' },
      { label: 'Sanctum', detail: 'Token-based authentication validates requests' },
      { label: 'Laravel API', detail: 'Business logic and data validation' },
      { label: 'MySQL', detail: 'Persistent data storage for properties and users' },
      { label: 'Pinia', detail: 'Centralized state synced across components' },
    ],
    challenges: [
      'Keeping frontend state in sync with the Laravel API across multiple views.',
      'Designing a decoupled SPA architecture with proper authentication flow using Sanctum.',
      'Handling form validation errors gracefully between Laravel and Vue.js.',
    ],
    learned: [
      'Building a full-stack SPA with a decoupled Laravel API and Vue.js frontend.',
      'Implementing secure token-based authentication with Laravel Sanctum.',
      'Structuring Vue.js applications with Pinia for efficient state management.',
    ],
    tech: ['Laravel 11', 'PHP', 'Vue.js 3', 'MySQL', 'Pinia', 'Axios', 'Vue Router', 'Sanctum', 'Vite', 'JavaScript'],
    demoCredentials: [
      { role: 'User', email: 'yash@staynest.test', password: 'password' },
    ],
    links: {
      demo: '',
      github: 'https://github.com/yashdhiman6455/staynest',
    },
  },
  {
    id: 'getmyinvoices',
